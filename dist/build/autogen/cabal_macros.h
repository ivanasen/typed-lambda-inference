...
/* package typed-lambda-inference-0.1.0.0 */
#ifndef VERSION_typed_lambda_inference
#define VERSION_typed_lambda_inference "0.1.0.0"
#endif /* VERSION_typed_lambda_inference */
#ifndef MIN_VERSION_typed_lambda_inference
#define MIN_VERSION_typed_lambda_inference(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_typed_lambda_inference */
...
#define CURRENT_PACKAGE_KEY "typed-lambda-inference-0.1.0.0-B8pWrZ9uStV4aMYa3Hovak"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "typed-lambda-inference-0.1.0.0-B8pWrZ9uStV4aMYa3Hovak"
